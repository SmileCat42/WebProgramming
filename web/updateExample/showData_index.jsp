...
<html>
    ...
    <%
       // request.setCharacterEncoding("UTF-8");
        ...
        Connection c = DriverManager.getConnection("jdbc:mysql://localhost/test1?autoReconnect=true&useSSL=false", "root", "1234");
        Statement s = c.createStatement();
        ResultSet rec = s.executeQuery("Select * from resume");
    %>
