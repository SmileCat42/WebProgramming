    ...
    protected void doGet(HttpServletRequest r, HttpServletResponse s)
        ...
        try {
            ...
            if ("edit".equals(action)) {
                ...
                Resume res = dao.findById(id);

                r.setAttribute("resume", res);

                r.getRequestDispatcher("/Chapter8_MVC/edit.jsp")
                        .forward(r, s);
                return;
            }
    ...
    protected void doPost(HttpServletRequest r, HttpServletResponse s)
        ...
        try {
            ...
            if ("update".equals(action)) {
                dao.update(x);   // ✅ ใช้ update
            } else {
                dao.insert(x);   // ใช้ตอนเพิ่มข้อมูล
            }
            s.sendRedirect("/Project1_JSP/mvc");
        } catch (Exception e) {
            throw new ServletException(e);
        }
    }
